...
import 'package:login_api2/kitap.dart';
...
class _HomeState extends State<Home> {
  ...
  Future getData() async {
    ...
    var response = document
        .getElementsByClassName("col-lg-8 col-md-8 col-sm-9 dsp-flex")[0]
        .getElementsByClassName("col-lg-6 col-md-6 col-sm-6")
        // .getElementsByClassName('plyr__c aptions')
        .forEach((element)
         {
      setState(() {
        print(element.children[0].children[0].children[0].children[0].attributes['src'].toString());
       kitaplar.add(
        
          Kitap(
            
              // image: element.children[2].children[0].children[0].children[0]
              image: element.children[0].children[0].children[0].children[0].attributes['src'].toString(),
              // kitapAdi: element.children[1].text.toString(),
